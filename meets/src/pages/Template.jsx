...
import { Box, Typography, Button, Table, TableBody, TableCell, TableContainer, TableRow, TextField, Select, MenuItem, Chip } from '@mui/material';
...
export default function Template() {
  ...
  // Add new state for repeat overlay
  ...
  const handleRepeatSave = (repeatOption, details) => {
    handleMeetingChange('repeatType', repeatOption);
    setIsRepeatOpen(false);
  };
        ...
        <TableContainer sx={tableContainerStyle}>
          <Table sx={tableStyle}>
            <TableBody>
              ...
              <TableRow>
                <TableCell sx={headerCellStyle}>Repeat Type</TableCell>
                <TableCell sx={cellStyle}>
                  <Box sx={{ display: 'flex', alignItems: 'center' }}>
                    {isPreview ? (
                      <Typography sx={{ padding: '8px 0', color: '#374151' }}>
                        {meetingDetails.repeatType || 'Not specified'}
                      </Typography>
                    ) : (
                      <TextField
                        variant="standard"
